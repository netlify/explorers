        ...
        <header className="ncn-header">
          <a href="https://netlify.com" className="ncn-home">
            ...
            >
              ...
              <g fill="none" fillRule="evenodd">
                ...
                />
                <path
                  fill="url(#ncn-home-logo-gradient)"
                  fillRule="nonzero"
          ...
          >
            ...
            <nav className="ncn-menu-c" data-close-click-outside-curtain>
              <a
                href="https://www.netlify.com/community/"
              ...
              <a
                href="https://explorers.netlify.com/"
          ...
          <details
            className="ncn-submenu"
            data-close-click-outside="(max-width: 63.1875em)"
            data-force-state-closed="(max-width: 63.1875em)"
            data-close-esc="(max-width: 63.1875em)"
            data-modal="(max-width: 39.9375em)"
          >
            <summary className="ncn-submenu-summary">
              <div className="ncn-submenu-hed">
                <svg
                  viewBox="0 0 31 25"
                  className="ncn-hamb"
                  aria-hidden="true"
                ...
                <span className="ncn-visual-hidden">Menu</span>
              </div>
            </summary>
            <nav className="ncn-submenu-c" data-close-click-outside-curtain>
              <Link href="/missions" as="/missions">
                <a className="ncn-submenulink">Missions</a>
              </Link>
              <Link href="/about" as="/about">
                <a className="ncn-submenulink">About</a>
              </Link>
              <span className={`ncn-submenulink ${styles.spacer}`}></span>
              {renderUser()}
            </nav>
          </details>
        </header>
...
function renderUser() {
  ...
  if (user && user.full_name) {
    return (
      <>
        <Link href="/profile">
          <a className={`ncn-submenulink ${styles.avatarLink}`}>
        ...
        <Link href="/">
          <a
            className={`ncn-submenulink ${styles.logoutLink}`}
            onClick={logoutUser}
          >
            Logout
          </a>
    ...
    return (
      <div className={`ncn-submenulink ${styles.buttonContainer}`}>
